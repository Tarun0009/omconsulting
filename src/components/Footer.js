      ...
      <div className="container mx-auto px-4 lg:px-12">
        <div className="flex flex-wrap lg:flex-nowrap justify-between items-start gap-6">
          ...
          <div className="w-full lg:w-1/5">
            ...
            <p className="text-gray-300 text-xs font-semibold ">
              OM Tech Solutions is a digital marketing company offering a range
              of services to help businesses grow online.
            </p>
            <div className="flex space-x-4 mt-3">
              <a
                href="https://www.facebook.com/omconsultingpvtltd"
                target="_blank"
              ...
              <a
                href="https://www.instagram.com/om_tech__solutions?igsh=cDd3a3U3dGgwaGVl&utm_source=qr"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-300 hover:text-yellow-500"
              >
              ...
              <a
                href="https://www.linkedin.com/company/omconsultingpvtltd"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-300 hover:text-yellow-500"
              >
              ...
              <a
                href="https://x.com/om_tec_solution?s=21"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-300 hover:text-yellow-500"
              >
          ...
          {/* Quick Links */}
          <div className="w-full lg:w-1/5">
            <h3 className="text-sm font-semibold mb-3 uppercase tracking-wider text-gray-200">
              Quick Links
            </h3>
            <ul className="space-y-1 text-gray-300 text-xs">
              ...
              <li>
                <Link to="/digital-marketing" className="hover:text-yellow-500">
                  Digital Marketing Services
                </Link>
              </li>
              <li>
                <Link to="/development" className="hover:text-yellow-500 ">
                  Development
                </Link>
              </li>
              <li>
                <Link to="/designing" className="hover:text-yellow-500">
                  Designing
                </Link>
              </li>
              <li>
          ...
          <div className="w-full lg:w-1/5">
            ...
            <ul className="space-y-1 text-gray-300 text-xs">
              <li>
                <Link to="web-development" className="hover:text-yellow-500">
                  Web Development
                </Link>
              </li>
              <li>
                <Link to="app-development" className="hover:text-yellow-500">
                  App Development
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="seo-optimization" className="hover:text-yellow-500">
                  SEO Optimization
                </Link>
              </li>
              <li>
                <Link to="email-marketing" className="hover:text-yellow-500">
                  Email Marketing
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="content-marketing" className="hover:text-yellow-500">
                  Content Marketing
                </Link>
              </li>
              <li>
                <Link to="logo-designing" className="hover:text-yellow-500">
                  Logo Designing
                </Link>
              </li>
              <li>
                <Link to="paid-advertising" className="hover:text-yellow-500">
                  Paid Advertising
                </Link>
              </li>
            </ul>
          ...
          <div className="w-full lg:w-1/5">
            ...
            <div className="flex items-start text-gray-300 text-xs mb-2">
              <FaMapMarkerAlt className="mr-5 text-yellow-500  lg:text-2xl" />
              <p>
                216-221, 2nd Floor, Om Tower, Commercial Belt, Alpha-1, Greater
                Noida, U.P. India
              </p>
            </div>
        ...
        <div className="border-t border-gray-700 mt-6 pt-3 text-center relative rounded-full">
          ...
          <p className="text-gray-400 text-xs">
            &copy; {new Date().getFullYear()} OM Tech Solutions. All Rights
            Reserved.
            <Link
              to="/privacy-policy"
              className="ml-2 hover:text-yellow-500 text-xs"
            >
              Privacy Policy
            </Link>{" "}
            |
            <Link
              to="/terms-of-service"
              className="hover:text-yellow-500 text-xs"
            >
              Terms of Service
            </Link>
          </p>
